  ...
  <div class="sidebar">
    ...
    <section class="home-section p-3 bg-slate-200">
        <div class="mx-auto overflow-x-auto p-6 bg-white rounded-3xl shadow-md text-center items-center">
            ...
            <a href="editdetail_careForm.php?user_id=<?php echo $user_id; ?>" class="text-xl bg-yellow-400 text-black rounded inline-block mt-18 mb-24 px-8 py-2">แก้ไขข้อมูล</a>
            <?php ?>
            <?php } else { ?>
